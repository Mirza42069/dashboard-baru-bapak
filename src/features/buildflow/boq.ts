...
export const boqSeedLeaves: BoqLeaf[] = [
  { id: 'l1', sectionId: 's1', code: '1.01', desc: 'Excavate to reduce levels', unit: 'm³', qty: 1240, rate: 18.5, pct: 100 },
  { id: 'l2', sectionId: 's1', code: '1.02', desc: 'Mass concrete fill to foundations', unit: 'm³', qty: 320, rate: 142, pct: 100 },
  { id: 'l3', sectionId: 's1', code: '1.03', desc: 'Reinforcement to pile caps', unit: 't', qty: 28, rate: 1450, pct: 80 },
  { id: 'l4', sectionId: 's2', code: '2.01', desc: 'In-situ RC columns', unit: 'm³', qty: 96, rate: 410, pct: 60 },
  { id: 'l5', sectionId: 's2', code: '2.02', desc: 'Precast floor planks', unit: 'm²', qty: 2150, rate: 88, pct: 45 },
  { id: 'l6', sectionId: 's2', code: '2.03', desc: 'Structural steel transfer beams', unit: 't', qty: 41, rate: 2100, pct: 20 },
  { id: 'l7', sectionId: 's3', code: '3.01', desc: 'Curtain walling — unitised', unit: 'm²', qty: 1340, rate: 540, pct: 0 },
  { id: 'l8', sectionId: 's3', code: '3.02', desc: 'Single-ply membrane roofing', unit: 'm²', qty: 880, rate: 96, pct: 0 },
]
